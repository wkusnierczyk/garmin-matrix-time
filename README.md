...
The initial pattern of glyphs and the starting position of each falling column are random, and seeded from the clock, so the rain begins differently on every launch. Two watches side by side do not fall into step.
