...
// compiles at all, before any Premium feature has put code in it, and that it stays out of
// Lite. On Lite's path it would run in the Lite suite and fail on the Lite name.
//
